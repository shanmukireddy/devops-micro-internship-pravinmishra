...
![alt text](screenshots/EC2-summary.jpg)
...
![alt text](screenshots/node-npm.jpg)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![alt text](screenshots/satus-nginx.jpg)
---

#### Screenshot 10 — Output of `mysql --version`

![alt text](screenshots/sql-version.jpg)
...
![alt text](screenshots/show-tables.jpg)
...
![alt text](<screenshots/EpicBook application .jpg>)
