...
![alt text](screenshots/4-rg-configuration.jpg)
...
![alt text](screenshots/5.linux-vm.jpg)
...
![alt text](screenshots/6.terraform-init.jpg)
...
![alt text](screenshots/7.terraform-plan.jpg)
![alt text](screenshots/7.terraform-plan1.jpg)

---

#### Screenshot 8 — Terraform apply output showing successful completion

![alt text](screenshots/8-9.terraform-apply.jpg)
...
VM Public IP Address: "9.205.25.102"
---
...
![alt text](screenshots/10.cli-vm-status.jpg)
...
![alt text](screenshots/11.terraform-destroy.jpg)
